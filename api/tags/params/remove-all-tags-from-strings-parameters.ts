...
export class RemoveAllTagsFromStringsParameters extends BaseParameters {
    setStringHashcodes(stringHashcodes: Array<string>): RemoveAllTagsFromStringsParameters {
